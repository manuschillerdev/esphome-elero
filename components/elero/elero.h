...
class Elero : public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST, spi::CLOCK_POLARITY_LOW, spi::CLOCK_PHASE_LEADING,
 ...
 public:
  ...
  EleroMode get_mode() const { return device_manager_ ? device_manager_->mode() : EleroMode::NATIVE; }
 ...
 private:
  ...
  // Device manager (nullptr = native mode, set by elero_mqtt component)
